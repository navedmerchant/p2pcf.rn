...
const getBrowserRTC = () => ({
  ...
  RTCIceCandidate,
  mediaDevices,
  // Minimal local errCode implementation for React Native
  errCode,
});
const { EventEmitter } = require('events');

// Simple inline replacement for `err-code` to avoid the dependency in RN
...
// Minimal inline replacements for removed deps:

// randomstring: generate a 20-char URL-safe id (letters+digits)
...
// queueMicrotask: use native if available; otherwise Promise microtask
